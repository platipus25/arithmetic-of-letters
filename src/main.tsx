...
function Input(props: any) {
  return (
    <div class="flex p-0 border-0 border-b-4 text-gray-900 border-gray-400  focus-within:border-indigo-400 focus:ring-inset sm:leading-6">
      <input
        {...props}
        type="text"
  ...
  return (
    <div class="grid relative">
      <div id="headerbox" class="left-0 right-0 top-0 p-2 bg-gray-800">
        <h1 class="text-2xl font-display text-gray-100">
...
`}</pre>
        <pre>{(grammar as any).source.sourceString}</pre>
      </div>
